...
if (isset($_POST['submit'])) {
    ...
    $ketapang  = $_POST['Ketapang_kencana'];
    $sengon  = $_POST['Sengon'];

    // $result = mysqli_query($con, "INSERT INTO stok_bibit() VALUES()") or die(mysqli_error($con));
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong>PENGURANGAN STOK BIBIT</strong>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="Ketapang kencana" class="control-label">Ketapang kencana</label>
                    <input type="number" class="form-control" name="Ketapang kencana" placeholder="Ketapang kencana">
                </div>
                <div class="form-group col-md-2">
